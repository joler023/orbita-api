...
public static class RolePermissions
{
    ...
    {
        [MemberRole.Owner] = new HashSet<Permission> { Permission.ViewTeam, Permission.ManageTeam, Permission.ManageSettings, Permission.ManageBilling, Permission.ViewAuditLog, Permission.ViewPipeline, Permission.ManagePipeline }.ToFrozenSet(),
        [MemberRole.Admin] = new HashSet<Permission> { Permission.ViewTeam, Permission.ManageTeam, Permission.ManageSettings, Permission.ViewAuditLog, Permission.ViewPipeline, Permission.ManagePipeline }.ToFrozenSet(),
        [MemberRole.Agent] = new HashSet<Permission> { Permission.ViewTeam, Permission.ViewPipeline }.ToFrozenSet(),
