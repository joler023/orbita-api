...
|---|---|---|---|
| A — Plataforma, Identidad y Facturación | Desarrollador 1 | Platform, Identity & Tenancy, Billing, Audit | `ORB-A05` (registro), `ORB-A09` (aislamiento), `ORB-A06` (sesión), `ORB-A07` (invitaciones), `ORB-A08` (roles y permisos), `ORB-A10` (recuperación de contraseña), `ORB-A11` (2FA) |
