...
Todavía no está el resto de la bandeja (`ORB-B12`–`ORB-B15`: vista de conversación con paginado, tiempo real, asignación), Instagram como canal completo (`ORB-B09`/`ORB-B10`, detrás del App Review de Meta) ni el agente ejecutando acciones sobre el CRM (`ORB-C05`–`ORB-C09`: herramientas tipadas, guardrails, traspaso a humano, enrutador y registro de consumo) — se construye incrementalmente replicando el mismo patrón. El backlog completo de 61 historias está en [`../docs/Orbita-Historias-de-Usuario.pdf`](../docs/Orbita-Historias-de-Usuario.pdf).
