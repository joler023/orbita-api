...
- **Exportación CSV** (`GET /api/tenants/{tenantId}/exports/contacts`, `.../exports/opportunities`): descarga síncrona con BOM UTF-8. Borrador de `ORB-D13` (async + R2 y export de conversaciones vienen después).
...
| D — CRM, Contenido y Analítica | Desarrollador 4 | CRM, Campaigns, Analytics, sitio público | `ORB-D04` (pipelines), `ORB-D05` (tablero), `ORB-D02` (contactos), `ORB-D03` (búsqueda), `ORB-D13` (export CSV sync) |
