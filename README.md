...
Todavía no está el resto de la bandeja (`ORB-B12`–`ORB-B15`: vista de conversación con paginado, tiempo real, asignación), Instagram como canal completo (`ORB-B09`/`ORB-B10`, detrás del App Review de Meta) ni el traspaso a una persona (`ORB-C07`, que necesita la asignación de `ORB-B15`: sin una cola humana detrás, prometerle un traspaso al cliente sería mentirle) — se construye incrementalmente replicando el mismo patrón. El backlog completo de 61 historias está en [`../docs/Orbita-Historias-de-Usuario.pdf`](../docs/Orbita-Historias-de-Usuario.pdf).
