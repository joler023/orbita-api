...
Todavía no está el resto de la bandeja (`ORB-B12`–`ORB-B15`: vista de conversación con paginado, tiempo real, asignación), Instagram como canal completo (`ORB-B09`/`ORB-B10`, detrás del App Review de Meta) ni el agente respondiendo o ejecutando acciones sobre el CRM (`ORB-C04`–`ORB-C09`, que es lo que junta Channels con Agentes de IA) — se construye incrementalmente replicando el mismo patrón. El backlog completo de 61 historias está en [`../docs/Orbita-Historias-de-Usuario.pdf`](../docs/Orbita-Historias-de-Usuario.pdf).
